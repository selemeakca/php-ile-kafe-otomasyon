        ...
        if ($buton) :
            ...
            <?php
                    echo '<div class="col-md-12 table-light border-bottom"><h4>GARSON EKLE</h4></div>
                            <div class="col-md-12 table-light"><input type = "text" name = "garsonad" class = "form-control mt-3" require /></div>
                            <div class="col-md-12 table-light"><input type = "text" name = "garsonsifre" class = "form-control mt-3" require /></div>
                            <div class="col-md-12 table-light"><input name = "buton" value = "Ekle" type = "submit" class = "btn btn-success mt-3 mb-3"/></div>
                    </form>';
        ...
        if ($buton) :
            ...
            <?php
                    ...
                    echo '<div class="col-md-12 table-light border-bottom"><h4>GARSON GÜNCELLE</h4></div>
                            ...
                            <div class="col-md-12 table-light">Garson Şifre<input type = "text" name = "garsonsifre" class = "form-control mt-3" value = "'.$aktar["sifre"].'"/></div>
                            <div class="col-md-12 table-light"><input name = "buton" value = "Güncelle" type = "submit" class = "btn btn-success mt-3 mb-3"/></div>
        ...
        if ($buton) :
            ...
            <?php
                    echo '<div class="col-md-12 table-light border-bottom"><h4>YÖNETİCİ EKLE</h4></div>
                        ...
                        <div class="col-md-12 table-light"><input type = "text" name = "yonsifre" class = "form-control mt-3" require placeholder = "Yönetici Şifre"/></div>
                        <div class="col-md-12 table-light"><input name = "buton" value = "Ekle" type = "submit" class = "btn btn-success mt-3 mb-3"/></div>
        ...
        public function sifredegistir ($vt) {
            ...
            if ($buton) :
                    ...
                    if ($eskisifre == "" || $yeni1 == "" || $yeni2 == "") :
                        ...
                        if($this->genelsorgu($vt, "select * from yonetim where sifre = '$eskisifreson' ")->num_rows == 0) :
